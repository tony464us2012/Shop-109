...
export const userLoginReducer = (state = {loading: false, guest: true, userInfo: null}, action) => {
    switch (action.type) {
        case USER_LOGIN_REQUEST:
            return { loading: true }
        case USER_LOGIN_SUCCESS:
            return { loading: false, guest: false, userInfo: action.payload }
        case USER_LOGIN_FAIL:
        return { loading: false, error: action.payload }
        case USER_LOGOUT: 
        return {loading: false, guest: true, userInfo: {} }
        default: 
            return state
    }
}
